    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('validUser', models.ManyToManyField(related_name='validUserTravel', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='meetTravelInfo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voteUser', models.IntegerField(default=0)),
                ('meetId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='meetings.meetings', verbose_name='약속 PK')),
                ('validUser', models.ManyToManyField(related_name='validUserDay', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='meetDayInfo',
